...
#
# This is a renamed copy of Ogg::Vorbis::Header::PurePerl,
# Copyright (c) 2003, Andrew Molloy. All Rights Reserved.
#
package gnump3d::ogginfo;
...
sub comment 
{
    ...
    return undef if not defined( $self->{'COMMENTS'} );
...
sub add_comments 
{
    warn "gnump3d::ogginfo add_comments() unimplemented.";
}

sub edit_comment 
{
    warn "gnump3d::ogginfo edit_comment() unimplemented.";
}

sub delete_comment 
{
    warn "gnump3d::ogginfo delete_comment() unimplemented.";
}

sub clear_comments 
{
    warn "gnump3d::ogginfo clear_comments() unimplemented.";
}
...
sub write_vorbis
{
    warn "gnump3d::ogginfo write_vorbis unimplemented.";
}
...
gnump3d::ogginfo - An object-oriented interface to Ogg Vorbis
...
=head1 SYNOPSIS
	...
	use gnump3d::ogginfo;
	my $ogg = gnump3d::ogginfo->new("song.ogg");
